 ...
 * @author BIMSARA
 */
public class CustLoginJFrame extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if (role.equals("Customer")) {
            CustDashboardJFrame mf = new CustDashboardJFrame(username);
            mf.setVisible(true);
            this.dispose();
        } 
    } else {
    ...
    private void lblRegisterMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblRegisterMouseClicked
        CustRegisterJFrame rf = new CustRegisterJFrame();
        rf.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustLoginJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustLoginJFrame().setVisible(true);
            }
        });
    }
